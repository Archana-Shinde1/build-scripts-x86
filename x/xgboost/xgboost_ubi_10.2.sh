...
yum install -y git make cmake wget python3.14 python3.14-devel python3.14-pip pkgconfig gcc gcc-c++ gcc-gfortran graphviz
...
pip install numpy==2.5 packaging pathspec pluggy trove-classifiers wheel build hatchling joblib threadpoolctl scikit-build-core
